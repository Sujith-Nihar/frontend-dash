    ...
    return (
        <div className="sidebar sidebar-color col-2 p-0 ps-0 m-0 rounded-right shadow-max pt-2">
            ...
            <div className='d-flex border-bottom'>
                <SideButton icon={"home-side.png"} iconh={18} iconw={18} classname={"big-font sidebutton sidebutton-color  p-2 d-flex justify-content-start align-items-center"} id={'dashboard-btn'} name={'Monitoring'} path={'/'} />
            ...
            <Collapse in={open} unmountOnExit>
                ...
                <SideButton icon={"mcu.png"} iconh={17} iconw={17} classname={"sidebutton sidebutton-color p-2 d-flex justify-content-start align-items-center border-bottom"} id={'ggdevice-btn'} name={'Edge Devices'} path={'/edgedevice'} />
