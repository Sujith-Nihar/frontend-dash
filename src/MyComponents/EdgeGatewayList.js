    ...
    <div className="col-10 p-0 m-0 pt-4">
      ...
      <div className='row p-3'>
        <div className='col-4'>        
          ...
          <CountDevices link={"https://img.icons8.com/external-nawicon-glyph-nawicon/64/228BE6/external-cloud-computing-internet-of-things-nawicon-glyph-nawicon.png"} bg={"flex-stretch count-box m-1 rounded shadow-max"} name={'Number of Edge Gateways'} count={2} />
        </div>
      </div>
